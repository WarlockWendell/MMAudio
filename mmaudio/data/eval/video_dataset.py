...
class JavisBench(Dataset):
    def __init__(
        ...
        *,
        ...
        self.video_path = metadata['path'].tolist()
        self.video_id = metadata['id'].tolist()
        self.captions = metadata['audio_text'].tolist()
...
class Landscape(JavisBench):
    pass

class AIST(JavisBench):
    pass
